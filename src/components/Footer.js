export function Footer() {
    ...
    footer.classList = "mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8";
    footer.innerHTML = `<div class="sm:flex sm:items-center sm:justify-between">
                <div class="text-teal-600 dark:text-teal-300">
                    <img src="src/assets/logo.png" alt="Clothes Shop Logo" class="h-8" />
                </div>
